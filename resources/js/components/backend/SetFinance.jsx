...
export default function SetFinance() {
    ...
    const handleSubmit = (e) => {
        ...
        axios
            ...
            .then((result) => {
                ...
                setSucc("Department Added succesively");
    ...
    const handleEdit = (e, ImgId) => {
        ...
        axios
            .post(`/api/finance/update/${ImgId}`, fd, {
                headers: {
                    "content-type": "multipart/form-data",
                },
            })
