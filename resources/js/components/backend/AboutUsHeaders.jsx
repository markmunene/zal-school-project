...
export default function SetAboutUsHeader() {
    ...
    const [eItems, setEditaboutHeaders] = useState([]);
    ...
    const removeSection = (id) => {
        const newaboutHeadersHeaders = fetchedaboutHeaders.filter(
            (item) => item.id !== id
        );

        setFetchedaboutHeaders(newaboutHeadersHeaders);
    };
    // handling the image
    ...
    const editDataHandling = (items) => {
        ...
        return setEditaboutHeaders(items);
    };
    ...
    const handleSubmit = (e) => {
        ...
        axios
            .post("/api/aboutHeaders/store", fd)
            .then((result) => {
                // setsectionHeader("");
                // setsectionTitle("");
                setFeedback(true);
                ...
                setSucc("aboutHeaders Headers Added Succesively");
    ...
    const handleEdit = (e, MsectionId) => {
        ...
        axios
            .post(`/api/aboutHeaders/update/${MsectionId}`, fd)
            .then((result) => {
                setFeedback(true);
                setTimeout(() => {
                    setFeedback(false);
                ...
                setSucc("aboutHeaders Header Updated Succcessively");
                                ...
                                <button
                                    ...
                                    onClick={async () => {
                                        try {
                                            await axios
                                                .delete(
                                                    `/api/aboutHeaders/${MMainSectionId}`
                                                )
                                                .then((response) => {
                                                    removeSection(
                                                        MMainSectionId
                                                    ...
                                                    setSucc(
                                                        "aboutHeaders Header Section Deleted Succesively"
                                                    );
                                                    $(
                                                        modalDelete.current
                                                    ).modal("hide");
                        ...
                        <div className="card card-primary collapsed-card">
                            <div className="card-header">
                                ...
                                <h3 className="card-title">
                                    aboutHeaders Us Headers Section
                                </h3>
